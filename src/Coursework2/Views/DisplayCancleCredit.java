...
public class DisplayCancleCredit extends JFrame {

    public DisplayCancleCredit(ArrayList<BankCard> bankCards){
        super("Display Credit Cancel Cards");
        ...
        String[] columnNames = {"Card Id", "Client Name", "Issue Bnak", "Bank Account", "Balance Amount", "CVC Number", "Credit Limit","Grace Period","Is Granted"};
        ...
        for (int i = 0; i < creditCards.size(); i++) {
            ...
            data[i][6] = String.valueOf(creditCards.get(i).getCreditLimit());
            data[i][7] = String.valueOf(creditCards.get(i).getGracePeriod());
